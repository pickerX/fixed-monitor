...
public class VideoTitileView extends FrameLayout implements IControlComponent {
    ...
    private VideoTitileView.BatteryReceiver mBatteryReceiver;
    private boolean mIsRegister;//是否注册BatteryReceiver

    public VideoTitileView(@NonNull Context context) {
        super(context);
    }

    public VideoTitileView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public VideoTitileView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//                    mControlWrapper.stopFullScreen();
        ...
        mBatteryReceiver = new VideoTitileView.BatteryReceiver(batteryLevel);
    }
